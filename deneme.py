img_path="D:\\Thesis\\Datasets\\CityScapes\\Realimg_trainvaltest\\leftImg8bit\\val\\val"
label_path="D:\\Thesis\\Datasets\\CityScapes\\gtBbox_cityPersons_trainval\\gtBboxCityPersons\\val\\val"
...
datagen=data_gen(img_path,label_path,1280,640,1,2,Subset='reasonable',Augmentation=None)
for i in range(datagen.__len__()):
    img, center,scale,offset=datagen.__getitem__(27)
